                        ...
                        <div class="col-8 mt-3">
                            ...
                            <form action="user_registation" method="post" id="from">
                                <table class="form-group">
                                    <tr><td>Name <input type="text" name="username" class="form-control" id="fg" required></td></tr>
                                    <tr><td>Address <input type="text" name="address" class="form-control" id="fg"required></td></tr>
                                    <tr><td>Age <input type="text" name="age" class="form-control" id="fg"required></td></tr>
                                    <tr><td>Mobile <input type="text" name="mobleNumber" class="form-control" id="fg"required></td></tr>
